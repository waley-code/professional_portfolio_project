                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="about__education__item">
                                                        <h3 class="title">Bsc. Olabisi Onabanjo University</h3>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="about__education__item">
                                                        <h3 class="title">Operations Executive at Plus Marketing</h3>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="about__education__item">
                                                        <h3 class="title">Data Analyst - Google</h3>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="about__education__item">
                                                        <h3 class="title">Full Stack Software Developer</h3>
                                                        <span class="date">2020 - Till date</span>
                                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour,There are many variations of passages of Lorem Ipsum available, but the majority have suffered
                                                        alteration in some form, by injected humour.</p>
                                                    </div>
                                                </div>
                ...
                <div class="container">
                    <div class="row gx-0 justify-content-center">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog__post__item">
                                <div class="blog__post__thumb">
                                    <a href="#"><img src="assets/img/blog/blog_post_thumb02.jpg" alt=""></a>
                                    <div class="blog__post__tags">
                                        <a href="#">Social</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog__post__item">
                                <div class="blog__post__thumb">
                                    <a href="#"><img src="assets/img/blog/blog_post_thumb03.jpg" alt=""></a>
                                    <div class="blog__post__tags">
                                        <a href="#">Work</a>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="homeContact__content">
                                    ...
                                    <h2 class="mail"><a href="mailto:Info@webmail.com">walephlp@gmail.com</a></h2>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="homeContact__form">
                                     <form method="POST" action="{{route('store.message')}}" class="homeContact__form">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
