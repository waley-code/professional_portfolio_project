                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="menu__wrap">
                                <nav class="menu__nav">
                                    <div class="logo">
                                        <a href="index.html" class="logo__black"><img src=" {{ asset('frontend/assets/img/logo/waleycode-logo.png')}}" alt=""></a>
                                    ...
                                    <div class="header__btn d-none d-md-block {{ ($route == 'contact.me' ? 'active':'') }}"> <a href="{{route('contact.me')}}">
